...
import com.mochamadahya.mediasantri.EditProfileActivity
import com.mochamadahya.mediasantri.R
import com.mochamadahya.mediasantri.adapter.MyImagesAdapter
...
class ProfileFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        recyclerViewUploadImages = viewProfile.findViewById(R.id.rv_upload_picimage)
    ...
    private fun getFollowers() {
        ...
        followersRef.addValueEventListener(object : ValueEventListener{
            override fun onDataChange(p0: DataSnapshot) {
                if (p0.exists()){
                    view?.angka_followers?.text = p0.childrenCount.toString()
                }
            }
    ...
    private fun getFollowings() {
        ...
        followersRef.addValueEventListener(object : ValueEventListener{
            override fun onDataChange(p0: DataSnapshot) {
                if (p0.exists()){
                    view?.angka_following?.text = p0.childrenCount.toString()
                }
            }
            ...
            override fun onDataChange(p0: DataSnapshot) {
                if (p0.exists()){
                   ...
                   txt_username?.setText(user?.userName)
                    txt_profile_1?.setText( user?.fullname)
                   txt_profile_2?.setText(user?.bio)
                }
            }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btn_edit_profile.setOnClickListener {
            val intentke = Intent(context, EditProfileActivity::class.java)
            startActivity(intentke)
        }
    }
